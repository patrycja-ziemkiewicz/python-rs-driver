...
use pyo3::{
    Borrowed, Bound, BoundObject, FromPyObject, Py, PyAny, PyResult, Python, pyclass, pymethods,
    pymodule,
};
    ...
    async fn translate_address(
        ...
        Python::attach(|py| -> PyResult<SocketAddr> {
            ...
            let translated = py_trans
                .call_method1("translate", (peer_info,))?
...
impl<'py> FromPyObject<'_, 'py> for AddressTranslatorInput {
    ...
    fn extract(obj: Borrowed<'_, 'py, PyAny>) -> Result<Self, Self::Error> {
        ...
        if !obj.hasattr("translate").unwrap_or(false) {
...
impl<'py> FromPyObject<'_, 'py> for TimestampGeneratorInput {
    ...
    fn extract(obj: Borrowed<'_, 'py, PyAny>) -> Result<Self, Self::Error> {
        ...
        if !obj.hasattr("next_timestamp").unwrap_or(false) {
